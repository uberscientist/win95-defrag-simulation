...
~~~sh
git clone git@github.com:nko3/of-glob.git
~~~
...
~~~sh
npm install -g jitsu
jitsu login --username nko3-of-glob --password tc6qngz3sLrts5aF
jitsu deploy
~~~
...
~~~html
<iframe src="http://nodeknockout.com/iframe/of-glob" frameborder=0 scrolling=no allowtransparency=true width=115 height=25>
</iframe>
~~~
...
[2]: https://github.com/organizations/nko3/teams/280824
[3]: https://github.com/nko3/of-glob
